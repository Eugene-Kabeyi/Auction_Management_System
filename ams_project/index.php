...
<section class="hero">
    <h1>Welcome to Auctioneer Management System(AMS)</h1>
    <p>Auctions done in this system.</p>
...
<section class="about-section">
    <h2>About AMS</h2>
    <p>
        The Auctioneer Management System (AMS) is a web-based platform designed to simplify
